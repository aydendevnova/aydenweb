...
<ProjectImage src="/projects/stacks-turnkey-hackathon/btcu-homepage.png" alt="Bitcoin University landing page showing 'Learn Bitcoin with Rewards' headline with Stacks and sBTC branding" caption="The BTCU landing page. Courses, rewards, and on-chain credentials." />
...
That week was the first time the team met in person. We spent the days at the hacker house, watched other teams demo their projects, and had conversations with the Stacks Labs developer relations team about what came next for BTCU and the broader embedded wallet tooling on Stacks.
