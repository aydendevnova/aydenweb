...
I worked on BTCU with [Fred Martinez](https://x.com/fred_dog93) and [Michael Jagdeo](https://x.com/attractfund1ng). We built it using AI-assisted coding tools (Cursor and Claude Code), and the entire team operated remotely during the hackathon. My handle is [@aydendevnova](https://x.com/aydenspringer23).
...
[View BTCU on DoraHacks](https://dorahacks.io/hackathon/embedded-wallet/buidl) | [SDK Repository](https://github.com/aydenspringer/turnkey-stacksjs-sdk) | [Examples Repository](https://github.com/aydenspringer/turnkey-stacksjs-examples)
