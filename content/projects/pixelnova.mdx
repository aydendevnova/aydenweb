...
<ProjectImage src="/projects/pixelnova/convert_to_true_pixelart.png" alt="PixelNova conversion tool showing the original AI-generated arctic fox on the left and the 64x64 true pixel art conversion on the right, with resolution settings and quick presets" caption="The conversion tool. Upload an image, set the target resolution, and the algorithm produces true pixel art." />
...
<ProjectImage src="placeholder:PixelNova generation interface showing the prompt input field, generation settings, and output preview with download options" alt="PixelNova AI generation interface" caption="The generation interface. Prompt input, style options, and direct download." pixelated/>
...
<ProjectImage src="placeholder:PixelNova gallery view showing a grid of previously generated pixel art images with download and edit options" alt="User gallery showing generated pixel art" caption="The personal gallery. Every generation saved and accessible from anywhere." pixelated />

<ProjectImage src="placeholder:PixelNova pixel art editor showing the canvas, layer panel, color palette, and drawing tools" alt="PixelNova pixel art editor" caption="The built-in editor. Layers, color palette, and basic drawing tools."pixelated />
...
<ProjectImage src="placeholder:PixelNova pricing page showing the subscription tiers, generation credits, and unlimited conversion access" alt="PixelNova pricing page" caption="The pricing page. $9.99/month for 220 generations and unlimited conversions." />
