...
tools:
  ...
  - "Tailwind CSS"
  - "Figma"
description: "Two years of frontend development for a decentralized reputation and freelance platform on Bitcoin's Stacks network."
order: 2
featured: true
category: "featured"
---
...
<ProjectImage src="placeholder:Quest interface showing active quests with progress indicators, staking requirements, and activity types" alt="Quest system interface" caption="The quest system. Staking, activities, and seasonal resets." />
...
<ProjectImage src="placeholder:Events discovery page showing filterable event cards with dates, attendee counts, and join buttons" alt="Zero Authority events page" caption="The events module. Discovery, details, and creation." />
...
<ProjectImage src="placeholder:Endowment site landing page showing the organization's mission and project overview without wallet integration" alt="Zero Authority endowment site" caption="The endowment site. Public-facing, no wallet required." />
